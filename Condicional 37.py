...
#Os momentos de chegada ao parque e partida deste são apresentados na
#forma de pares de inteiros, representando horas e minutos.
#Por exemplo, o par 12 50 representará “dez para a uma da tarde”.
#Pretende-se criar um programa que, lidos pelo teclado os momentos de
#chegada e de partida, escreva na tela o preço cobrado pelo estacionamento.
#Admite-se que a chegada e a partida se dão com intervalo
#não superior a 24 horas. Portanto, se uma dada hora de chegada
#for superior à da partida, isso não é uma situação de erro,
